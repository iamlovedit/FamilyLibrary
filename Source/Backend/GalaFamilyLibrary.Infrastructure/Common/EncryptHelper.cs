...
public static class EncryptHelper
{
    ...
    public static string? EncryptAES(string plainText, string passPhrase, string iv)
    {
        ...
        {
            throw new ArgumentException($"��{nameof(plainText)}������Ϊ null ��ա�", nameof(plainText));
        }

        if (string.IsNullOrEmpty(passPhrase))
        {
            throw new ArgumentException($"��{nameof(passPhrase)}������Ϊ null ��ա�", nameof(passPhrase));
        }

        if (string.IsNullOrEmpty(iv))
        {
            throw new ArgumentException($"��{nameof(iv)}������Ϊ null ��ա�", nameof(iv));
        }
    ...
    public static string? DecryptAES(string cipherText, string passPhrase, string iv)
    {
        ...
        {
            throw new ArgumentException($"��{nameof(cipherText)}������Ϊ null ��ա�", nameof(cipherText));
        }
